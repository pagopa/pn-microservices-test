...
#CASE TEST KO
  ...
  Scenario Outline: Upload di un file da sottoporre a trasformazione senza xTraceId come header
    ...
    Examples:
      | clientId           | APIKey            | documentType                       | fileName      | MIMEType       | rc  |
      | @clientId-delivery | @delivery_api_key | @doc_type_notification_attachments | @filename_zip | @mime_type_zip | 400 |
...
# END TEST KO
  ...
  Scenario Outline: update dei metadata di un file - cambio status o retentionUntil
    ...
    Examples:
      ...
      | @clientId-delivery | @delivery_api_key | @doc_type_notification_attachments | @filename_pdf | @mime_type_pdf | pn-test    | pn-test_api_key | ATTACHED | 2024-07-11T13:02:25.206Z |
      | @clientId-delivery | @delivery_api_key | @doc_type_notification_attachments | @filename_pdf | @mime_type_pdf | pn-test    | pn-test_api_key | ATTACHED |                          |
      | @clientId-delivery | @delivery_api_key | @doc_type_notification_attachments | @filename_pdf | @mime_type_pdf | pn-test    | pn-test_api_key |          | 2024-07-11T13:02:25.206Z |
  ...
  Scenario Outline: tentativo di update dei metadata di un file con chiave invalida o non valorizzata
    ...
    Examples:
      ...
      | @clientId-pn_cn | @apiKey-pn_cn | ATTACHED | 2024-07-11T13:02:25.206Z | NONEXISTENT | 404 |
      | @clientId-pn_cn | @apiKey-pn_cn | ATTACHED | 2024-07-11T13:02:25.206Z |             | 400 |
