...
public class S3Utils {
    ...
    public static S3EventNotification createS3EventNotification(String fileKey, String eventName, String bucketName) {
        ...
        S3 s3 = new S3("configurationId",
                new S3Bucket(bucketName, new UserIdentity("principalId"), "arn"),
